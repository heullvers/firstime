...
nomeArquivo = 'tim-seriea-2017-2018.csv'
with open(nomeArquivo, 'a+', newline='') as file:
    ...
    url = 'https://www.flashscore.com.br/futebol/italia/serie-a-2017-2018/resultados/'
    ...
    for match in linksJogos:
        ...
        try:
            ...
            print('Não foi possivel identificar os times')
