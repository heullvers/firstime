...
nomeArquivo = 'ligaeuropa-2009-2010.csv'
with open(nomeArquivo, 'a+', newline='') as file:
    ...
    url = 'https://www.flashscore.com.br/futebol/europa/liga-europa-2009-2010/resultados/'
    ...
    for match in linksJogos:
        ...
        try:
            ...
            try:
                ...
                pos += 1
                print('Não foi possível carregar o quadro de estatisticas')
        except:
            pos += 1
            print('Não foi possível carregar o quadro do primeiro tempo')
